<script type="text/javascript">$('.fecha').hide();$('.cro').hide();</script>
<?php
if (isset($user))
...
<?php
	if(isset($es))
	{	echo "<script type='text/javascript'>
						$('#nom, #tipo_nom, #dedicacion, #dependencia, #unidad, #fecha_init, #fecha_fin, #cronologia').attr('disabled', true);
						$('.cro').show();
					</script>";
	}
?>
<form  method="post" action="#" >
  ...
  <div class="row">
	...
	<div class="row">
		...
		<div class="form-group col-lg-12 cro">
			<label for="cronologia">Cronologia:</label>
			<input class="form-control" type="text" name="cronologia" id="cronologia">
		</div>
	</div>
</form>
